...
import { Plus, Search, Filter, Pencil, Trash2, Image as ImageIcon, Loader2, X } from "lucide-react";
                    ...
                    <DialogContent className="sm:max-w-[550px] bg-white text-stone-800">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid gap-4 py-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="grid gap-2">
                                        <Label htmlFor="name" className="text-stone-700">Product Name</Label>
                                        <Input
                                            id="name"
                                            value={formData.name}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="grid gap-2">
                                        <Label htmlFor="price" className="text-stone-700">Price</Label>
                                        <Input
                                            id="price"
                                            type="number"
                                            step="0.01"
                                    ...
                                    <div className="grid gap-2">
                                        <Label htmlFor="stock" className="text-stone-700">Stock Quantity</Label>
                                        <Input
                                            id="stock"
                                            type="number"
                                ...
                                {/* Image Upload */}
                                <div className="grid gap-2">
                                    <Label htmlFor="image" className="text-stone-700">Product Image</Label>
                            ...
                            <DialogFooter>
                                ...
                                <Button type="submit" disabled={uploading} className="bg-[#788F76] hover:bg-[#667c64] text-white">
                                    {uploading ? 'Uploading...' : (editingProduct ? 'Update Product' : 'Save Product')}
                                </Button>
                            </DialogFooter>
                        </form>
                    </DialogContent>
                    ...
                    {loading ? (
                        ...
                        <Table>
                            <TableHeader className="bg-stone-50">
                                <TableRow>
                                    <TableHead className="font-medium text-stone-600">Product</TableHead>
                                    <TableHead className="font-medium text-stone-600">Category</TableHead>
                                    <TableHead className="font-medium text-stone-600">Price</TableHead>
                                    <TableHead className="font-medium text-stone-600">Stock</TableHead>
                            ...
                            <TableBody>
                                ...
                                {filteredProducts.length === 0 ? (
                                    ...
                                    filteredProducts.map((product) => (
                                        <TableRow key={product._id} className="hover:bg-stone-50/50">
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <Badge className={`shadow-none border-none font-medium ${colorClass}`}>
                                                            {stock} in stock
                                                        </Badge>
                                                    );
                                                })()}
