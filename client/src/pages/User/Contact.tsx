      ...
      <section className="pt-32 pb-12 bg-[#f5f5f0]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-stone-600 leading-relaxed max-w-2xl mx-auto">
            Have questions about our models or need help with a custom layout?
            We're here to help you visualize perfection.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-2">
              <iframe
                src="https://forms.gle/oT4JnMUVyZRWpnCG8"
                width="100%"
                height="900"
                frameBorder="0"
                marginHeight={0}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <a
                        href="#"
                        className="block text-sm text-stone-600 hover:text-stone-900 underline"
                      >
                        WhatsApp Support
                      </a>
                      <a
